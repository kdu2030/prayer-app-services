...
namespace PrayerAppServices.Migrations
{
    ...
    [Migration("20251017125218_GetPrayerGroupSummariesByUser")]
    partial class GetPrayerGroupSummariesByUser
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PrayerAppServices.Users.Entities.AppUser", b =>
                {
                    ...
                    b.Property<int?>("ImageFileMediaFileId")
                        .HasColumnType("integer")
                        .HasColumnName("image_file_media_file_id");
                    ...
                    b.HasIndex("ImageFileMediaFileId")
                        .HasDatabaseName("ix_asp_net_users_image_file_media_file_id");
            ...
            modelBuilder.Entity("PrayerAppServices.Users.Entities.AppUser", b =>
                {
                    b.HasOne("PrayerAppServices.Files.Entities.MediaFile", "ImageFile")
                        .WithMany("AppUsers")
                        .HasForeignKey("ImageFileMediaFileId")
                        .HasConstraintName("fk_asp_net_users_media_files_image_file_media_file_id");
