...
namespace PrayerAppServices.Migrations
{
    ...
    [Migration("20251018214912_AddGroupNameTrgmIndex")]
    partial class AddGroupNameTrgmIndex
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PrayerAppServices.Files.Entities.MediaFile", b =>
                {
                    ...
                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int?>("MediaFileId"));
            ...
            modelBuilder.Entity("PrayerAppServices.JoinRequests.Entities.JoinRequest", b =>
                {
                    ...
                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int?>("JoinRequestId"));
                    ...
                    b.HasIndex("PrayerGroupId")
                        .HasDatabaseName("ix_join_requests_prayer_group_id");
            ...
            modelBuilder.Entity("PrayerAppServices.PrayerGroups.Entities.PrayerGroup", b =>
                {
                    ...
                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int?>("PrayerGroupId"));
                    ...
                    b.HasKey("PrayerGroupId")
                        .HasName("pk_prayer_groups");

                    b.HasIndex("AvatarFileId")
                        .HasDatabaseName("ix_prayer_groups_avatar_file_id");

                    b.HasIndex("BannerFileId")
                        .HasDatabaseName("ix_prayer_groups_banner_file_id");

                    b.HasIndex("GroupName")
                        .IsUnique()
                        .HasDatabaseName("ix_prayer_groups_group_name");
            ...
            modelBuilder.Entity("PrayerAppServices.PrayerGroups.Entities.PrayerGroupUser", b =>
                {
                    b.Property<int?>("PrayerGroupUserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasColumnName("prayer_group_user_id");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int?>("PrayerGroupUserId"));

                    b.Property<int>("PrayerGroupId")
                        .HasColumnType("integer")
                        .HasColumnName("prayer_group_id");

                    b.Property<int>("PrayerGroupRole")
                        .HasColumnType("integer")
                        .HasColumnName("prayer_group_role");

                    b.Property<int>("UserId")
                        .HasColumnType("integer")
                        .HasColumnName("user_id");

                    b.HasKey("PrayerGroupUserId")
                    ...
                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_prayer_group_users_user_id");

                    b.ToTable("prayer_group_users", (string)null);
                });

            modelBuilder.Entity("PrayerAppServices.PrayerRequests.Entities.PrayerRequest", b =>
                {
                    b.Property<int?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("PrayerAppServices.PrayerRequests.Entities.PrayerRequestBookmark", b =>
                {
                    ...
                    b.Property<int>("PrayerRequestId")
                        .HasColumnType("integer")
                        .HasColumnName("prayer_request_id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_prayer_request_bookmark");

                    b.HasIndex("PrayerRequestId")
                        .HasDatabaseName("ix_prayer_request_bookmark_prayer_request_id");

                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_prayer_request_bookmark_user_id");

                    b.ToTable("prayer_request_bookmark", (string)null);
                });

            modelBuilder.Entity("PrayerAppServices.PrayerRequests.Entities.PrayerRequestComment", b =>
                {
                    b.Property<int?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("PrayerAppServices.JoinRequests.Entities.JoinRequest", b =>
                {
                    b.HasOne("PrayerAppServices.PrayerGroups.Entities.PrayerGroup", "PrayerGroup")
                        ...
                        .HasConstraintName("fk_join_requests_prayer_groups_prayer_group_id");
            ...
            modelBuilder.Entity("PrayerAppServices.PrayerGroups.Entities.PrayerGroup", b =>
                {
                    b.HasOne("PrayerAppServices.Files.Entities.MediaFile", "AvatarFile")
                        .WithMany("PrayerGroups")
                        .HasForeignKey("AvatarFileId")
                        .HasConstraintName("fk_prayer_groups_media_files_avatar_file_id");

                    b.HasOne("PrayerAppServices.Files.Entities.MediaFile", "BannerFile")
                        .WithMany("BannerPrayerGroups")
                        .HasForeignKey("BannerFileId")
                        .HasConstraintName("fk_prayer_groups_media_files_banner_file_id");
            ...
            modelBuilder.Entity("PrayerAppServices.PrayerGroups.Entities.PrayerGroupUser", b =>
                {
                    ...
                    b.HasOne("PrayerAppServices.Users.Entities.AppUser", "User")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_prayer_group_users_users_user_id");
            ...
            modelBuilder.Entity("PrayerAppServices.PrayerRequests.Entities.PrayerRequestBookmark", b =>
                {
                    b.HasOne("PrayerAppServices.PrayerRequests.Entities.PrayerRequest", "PrayerRequest")
                    ...
                    b.HasOne("PrayerAppServices.Users.Entities.AppUser", "User")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_prayer_request_bookmark_users_user_id");
            ...
            modelBuilder.Entity("PrayerAppServices.Users.Entities.AppUser", b =>
                {
                    b.HasOne("PrayerAppServices.Files.Entities.MediaFile", "Image")
                        .WithMany("AppUsers")
            ...
            modelBuilder.Entity("PrayerAppServices.Files.Entities.MediaFile", b =>
                {
                    ...
                    b.Navigation("BannerPrayerGroups");
            ...
            modelBuilder.Entity("PrayerAppServices.PrayerRequests.Entities.PrayerRequest", b =>
                {
                    ...
                    b.Navigation("RequestBookmarks");

                    b.Navigation("RequestLikes");
                });
