...
namespace PrayerAppServices.Migrations
{
    ...
    [Migration("20251017123113_ChangeUserIDToAppUserID")]
    partial class ChangeUserIDToAppUserID
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PrayerAppServices.PrayerGroups.Entities.PrayerGroup", b =>
                {
                    ...
                    b.Property<int?>("BannerImageFileId")
                        .HasColumnType("integer")
                        .HasColumnName("banner_image_file_id");
                    ...
                    b.HasIndex("BannerImageFileId")
                        .HasDatabaseName("ix_prayer_groups_banner_image_file_id");
            ...
            modelBuilder.Entity("PrayerAppServices.PrayerGroups.Entities.PrayerGroup", b =>
                {
                    b.HasOne("PrayerAppServices.Files.Entities.MediaFile", "BannerImageFile")
                        .WithMany("BannerPrayerGroups")
                        .HasForeignKey("BannerImageFileId")
                        .HasConstraintName("fk_prayer_groups_media_files_banner_image_file_id");
