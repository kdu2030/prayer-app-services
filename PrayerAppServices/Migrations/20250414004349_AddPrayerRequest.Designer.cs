...
namespace PrayerAppServices.Migrations
{
    ...
    [Migration("20250414004349_AddPrayerRequest")]
    partial class AddPrayerRequest
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PrayerAppServices.PrayerRequests.Entities.PrayerRequestLike", b =>
                {
                    ...
                    b.HasIndex("AppUserId")
                        .HasDatabaseName("ix_prayer_request_like_app_user_id");
            ...
            modelBuilder.Entity("PrayerAppServices.PrayerRequests.Entities.PrayerRequestLike", b =>
                {
                    b.HasOne("PrayerAppServices.Users.Entities.AppUser", "AppUser")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_prayer_request_like_users_app_user_id");
